...
class F10eF10iM : public Scheme {
public:
  F10eF10iM(const Block_id &block_id, Mpi_boundary &mpi_boundary, const Parameter &parameter);
  ~F10eF10iM();
...
private:
  void heat_flux_closure(model::Fluid10 *fluid, const real *ten_moments_tmp, real *source, int species);
