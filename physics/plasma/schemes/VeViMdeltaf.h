...
#ifndef VEVIMDELTAF_H_
#define VEVIMDELTAF_H_
...
class VeViMdeltaf : public Scheme {
public:
  VeViMdeltaf(const Block_id &block_id, Mpi_boundary &mpi_boundary, const Parameter &parameter);
  ~VeViMdeltaf();
